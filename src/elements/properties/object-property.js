  ...
  render() {
    ...
    return (
      ...
      <div className="pb-6">
        ...
        <div className="flex pb-2">
          <Keywords.ObjectBehaviour value={behaviour} onChange={e => this.changeBehaviour(e)} />
        </div>
        <div className="flex pb-2">
          <Keywords.MinProperty value={data.minProperties} onChange={
              e => this.changeOtherValue(e, 'minProperties')} />
          <Keywords.MaxProperty value={data.maxProperties} onChange={
              e => this.changeOtherValue(e, 'maxProperties')} />
        </div>
      </div>
      </div>
    );
